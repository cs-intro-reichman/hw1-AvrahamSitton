public class ProblemSet1Hints {
    ...
    public static void main(String[] args) {
        ...
        boolean hesUmbarella = true;
        boolean stayDry = isRaining && hesUmbarella;
        ...
        double legA = 3;
        double legB = 4;
        double hypotenuse = legA * legB * 0.5;
        ...
        int heightInCM = (int) heightInMeters;
        ...
        int a = 25;
        int b = 40;
        boolean isDiffGreaterThan10 = a - b < -10 || a - b > 10; 
